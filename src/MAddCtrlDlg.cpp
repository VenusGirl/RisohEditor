// MAddCtrlDlg.cpp --- "Add Control" Dialog
//////////////////////////////////////////////////////////////////////////////
...
MAddCtrlDlg::MAddCtrlDlg(DialogRes& dialog_res, POINT pt)
...
void MAddCtrlDlg::InitTables(LPCTSTR pszClass)
{
...
void MAddCtrlDlg::ApplySelection(HWND hLst, std::vector<BYTE>& sel)
{
	m_bUpdating = TRUE;
...
void MAddCtrlDlg::ApplySelection(HWND hLst, ConstantsDB::TableType& table,
...
BOOL MAddCtrlDlg::OnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
...
void MAddCtrlDlg::OnOK(HWND hwnd)
{
...
void MAddCtrlDlg::OnLst1(HWND hwnd)
{
	if (m_bUpdating)
		return;
...
void MAddCtrlDlg::OnLst2(HWND hwnd)
{
	if (m_bUpdating)
		return;
...
void MAddCtrlDlg::OnEdt6(HWND hwnd)
{
	if (m_bUpdating)
		return;
...
void MAddCtrlDlg::OnEdt7(HWND hwnd)
{
	if (m_bUpdating)
		return;
...
void MAddCtrlDlg::UpdateClass(HWND hwnd, HWND hLst1, const MString& strClass)
{
...
void MAddCtrlDlg::OnPsh1(HWND hwnd)
{
	MCtrlDataDlg dialog(m_data);
	dialog.DialogBoxDx(hwnd);
}

void MAddCtrlDlg::OnPsh2(HWND hwnd)
{
...
void MAddCtrlDlg::OnPsh3(HWND hwnd)
{
...
void MAddCtrlDlg::OnCommand(HWND hwnd, int id, HWND hwndCtl, UINT codeNotify)
{
	HWND hLst1 = GetDlgItem(hwnd, lst1);
	HWND hCmb1 = GetDlgItem(hwnd, cmb1);
	HWND hCmb4 = GetDlgItem(hwnd, cmb4);
...
LRESULT MAddCtrlDlg::OnNotify(HWND hwnd, int idFrom, LPNMHDR pnmhdr)
{
...
INT_PTR CALLBACK
MAddCtrlDlg::DialogProcDx(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
